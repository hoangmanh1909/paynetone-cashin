...
public class MaterialCamera {
    ...
    private CharSequence mLabelInfo;
    private String mLabelOrderCode;
    ...
    public MaterialCamera setInfo(CharSequence info) {
        mLabelInfo = info;
        return this;
    }

    public MaterialCamera setIsAfter(boolean isAfter) {
        this.isAfter = isAfter;
        return this;
    }

    public MaterialCamera setOrderCode(String orderCode) {
        mLabelOrderCode = orderCode;
        return this;
    }
  ...
  */
    ...
    public Intent getIntent() {
        ...
        if (!TextUtils.isEmpty(mLabelInfo)) intent.putExtra(CameraIntentKey.LABEL_INFO, mLabelInfo);
        intent.putExtra(CameraIntentKey.LABEL_IS_AFTER, isAfter);
        if (!TextUtils.isEmpty(mLabelOrderCode))
            intent.putExtra(CameraIntentKey.LABEL_ORDER_CODE, mLabelOrderCode);
