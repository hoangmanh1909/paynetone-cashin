...
abstract class BaseCameraFragment extends Fragment
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mTvOrderCode = view.findViewById(R.id.tv_order_code);
        ...
        if (!TextUtils.isEmpty(((BaseCaptureActivity) getActivity()).labelInfo())) {
            mTvInfo.setText(((BaseCaptureActivity) getActivity()).labelInfo());
            mTvInfo.setVisibility(View.VISIBLE);
        } else {
            mTvInfo.setVisibility(View.GONE);
        }

        if (!TextUtils.isEmpty(((BaseCaptureActivity) getActivity()).labelOrderCode())) {
            String[] values = ((BaseCaptureActivity) getActivity()).labelOrderCode().split(";");
            if (values.length > 0) {
//                mTvPosition.setText(values[0]);
//                mTvPosition.setVisibility(View.VISIBLE);
                mTvOrderCode.setText(values[0]);
                mTvOrderCode.setVisibility(View.VISIBLE);
            } else {
//                mTvPosition.setVisibility(View.GONE);
                mTvOrderCode.setVisibility(View.GONE);
            }
        } else {
            mTvOrderCode.setVisibility(View.GONE);
        }
