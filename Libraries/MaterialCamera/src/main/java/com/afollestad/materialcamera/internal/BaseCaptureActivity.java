...
//            getFragmentManager().beginTransaction().replace(R.id.container, frag).commit();
    ...
    public int iconPause() {
        return getIntent().getIntExtra(CameraIntentKey.ICON_PAUSE, R.drawable.mcam_action_capture);
    }

    @DrawableRes
    @Override
    public int iconPlay() {
        return getIntent().getIntExtra(CameraIntentKey.ICON_PLAY, R.drawable.mcam_action_capture);
    }

    @DrawableRes
    @Override
    public int iconRestart() {
        return getIntent().getIntExtra(CameraIntentKey.ICON_RESTART, R.drawable.mcam_action_capture);
    }
    ...
    @Override
    public CharSequence labelInfo() {
        return getIntent().getCharSequenceExtra(CameraIntentKey.LABEL_INFO);
    }

    @Override
    public String labelOrderCode() {
        return getIntent().getStringExtra(CameraIntentKey.LABEL_ORDER_CODE);
    }
}
